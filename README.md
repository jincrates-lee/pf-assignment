...
- [x] API 명세는 Swagger 로 확인할 수 있어야 합니다. -> [스웨거 명세 interface 분리](https://github.com/jincrates-lee/pf-assignment/tree/main/src/main/java/me/jincrates/pf/assignment/bootstrap/http/docs)
